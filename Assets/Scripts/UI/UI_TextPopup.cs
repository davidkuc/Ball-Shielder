...
{
    public class UI_TextPopup : MonoBehaviour
    {
        ...
        public void SetPopupText(string text) => this.tmp_Text.text = text;
        ...
        public void Animation_Test()
        {
            ...
            LeanTween.scale(gameObject, targetScale, scaleTime).setEaseOutQuart().setLoopPingPong();
            LeanTween.moveY(gameObject, transform.position.y + y_MoveDistance, y_MoveTime).setEaseInElastic().setDelay(y_MoveUpDelay);
        }
